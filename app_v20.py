...
st.set_page_config(
    ...
    layout="wide",
    initial_sidebar_state="collapsed", # Começa com a sidebar fechada
)
load_dotenv()
...
# --- 5. O "MOTOR" DO AGENTE (V18 - VERSÃO LIMPA) ---
def processar_resposta_do_agente(response, chat_session):
    """
    Função V18 (Limpa).
    Processa a resposta, lida com loops de ferramentas, e atualiza o estado.
    """
    ...
    while processar_resposta_ia:
        ...
        if tool_match:
            ...
            for tool_call_tuple in individual_tool_calls:
                ...
                st.session_state.log_history.append({"role": "system", "content": f"ALEX usou ferramenta:\n{tool_call_str}"})
